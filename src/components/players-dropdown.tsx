  ...
  return (
    ...
    >
      <button
        ...
        title={isDisabled ? `No ${teamName} players found` : undefined}
      >
        Players
        <span
      ...
      {isOpen ? (
        <div
          id={menuId}
          className="absolute left-0 z-20 mt-2 max-h-96 w-72 max-w-[calc(100vw-2rem)] overflow-y-auto rounded-[18px] border border-border-strong bg-card p-3 shadow-[0_16px_40px_rgba(15,23,42,0.16)]"
          role="menu"
        >
